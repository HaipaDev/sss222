...
public class Tag_DmgPhaseFreq:MonoBehaviour{public bool firstDone;public float phaseFreqFirst=1f;public float phaseFreq=0.38f;public float phaseTimer=-4;
